...
const ocrController = __importStar(require("../controllers/ocr.controller"));
...
router.put('/update', ocrController.updateCutlistData);
// POST send WhatsApp confirmation for a cutting list
router.post('/send-whatsapp', ocrController.sendWhatsAppConfirmation);
